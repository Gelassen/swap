...
import com.example.wallet.debug.autogenerated.SwapValue
...
class WalletRepository(val context: Context) {
    ...
    fun mintToken(to: String, value: SwapValue.Value, uri: String): Flow<TransactionReceipt> {
    ...
    fun mintToken(to: String, value: SwapValue.Value, uri: String, wei: BigInteger): Flow<TransactionReceipt> {
