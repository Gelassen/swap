...
class DebugActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val debugView = findViewById<TextView>(R.id.debugInfo)
        debugView.text = "Hello world from debug activity!"

        findViewById<Button>(R.id.setupWallet)
            .setOnClickListener { setExistingWallet() }

        findViewById<Button>(R.id.createWallet)
            .setOnClickListener { createWallet() }

        findViewById<Button>(R.id.getCredentials)
            .setOnClickListener { getWalletAddress() }

        findViewById<Button>(R.id.testTransaction)
            .setOnClickListener { testTx() }

        findViewById<Button>(R.id.testBalance)
            .setOnClickListener {
    ...
    fun setExistingWallet() {
        ...
        if (!walletDir.exists()) {
            throw IllegalStateException("This wallet doesn't exist. Did you hardcoded correct file URI?")
        }
    }
    ...
    fun createWallet() {
        ...
        try {
            ...
            Log.d(App.WALLET, "New wallet is created ${walletDir.absolutePath}")
        } catch (e: java.lang.Exception) {
            //Display an Error
            Log.e(App.WALLET, "Failed to create wallet", e)
        }
    }
    ...
    private fun getWalletAddress() {
        try {
            ...
            //Show Error
            Log.e(App.WALLET, "Failed to obtain wallet credentials", e)
        }
    }
