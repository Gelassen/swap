...
public class GovernorCompatibilityBravo extends Contract {
    ...
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorCompatibilityBravo.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
