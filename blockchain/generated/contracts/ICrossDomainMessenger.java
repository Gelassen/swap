...
public class ICrossDomainMessenger extends Contract {
    ...
    public List<FailedRelayedMessageEventResponse> getFailedRelayedMessageEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(FAILEDRELAYEDMESSAGE_EVENT, transactionReceipt);
    ...
    public List<RelayedMessageEventResponse> getRelayedMessageEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(RELAYEDMESSAGE_EVENT, transactionReceipt);
    ...
    public List<SentMessageEventResponse> getSentMessageEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(SENTMESSAGE_EVENT, transactionReceipt);
