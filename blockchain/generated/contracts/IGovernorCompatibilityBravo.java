...
public class IGovernorCompatibilityBravo extends Contract {
    ...
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorCompatibilityBravo> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorCompatibilityBravo.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
