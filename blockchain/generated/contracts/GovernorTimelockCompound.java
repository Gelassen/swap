...
public class GovernorTimelockCompound extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> updateTimelock(String newTimelock) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_UPDATETIMELOCK, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(newTimelock)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<GovernorTimelockCompound> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorTimelockCompound.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorTimelockCompound> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorTimelockCompound.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorTimelockCompound> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorTimelockCompound.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorTimelockCompound> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorTimelockCompound.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
